...
public class DisplayMessageActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String message2 = intent.getStringExtra(MainActivity.MESSAGE_2);
        String message3 = intent.getStringExtra(MainActivity.MESSAGE_3) + ",";
        String message4 = intent.getStringExtra(MainActivity.MESSAGE_4);
        String message5 = intent.getStringExtra(MainActivity.MESSAGE_5);
//        String message5_2 = intent.getStringExtra(MainActivity.MESSAGE_5);
        ...
        TextView textView1_2 = findViewById(R.id.textEntry_1_2);
        ...
        TextView textView4_2 = findViewById(R.id.textEntry_4_2);
        TextView textView5 = findViewById(R.id.textEntry_5);
        TextView textView5_2 = findViewById(R.id.textEntry_5_2);
        ...
        textView1_2.setPaintFlags(textView1_2.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        ...
        textView4_2.setPaintFlags(textView4_2.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        textView5.setPaintFlags(textView5.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        textView5_2.setPaintFlags((textView5_2.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG));
        ...
        textView1_2.setText(message1); //name repeat
        textView2.setText(message2);
        textView3.setText(message3);
        textView4.setText(message4);
        textView4_2.setText(message4);
        textView5.setText(message5);
        textView5_2.setText(message5); //object repeat
